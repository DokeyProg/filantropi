  ...
  connectedCallback() {
    this.html = `<style>
      ...
      input[type=password] {
        ...
        background: #fff;
        border: 1px solid #401609;
        border-top: 1px solid #401609;
        border-radius: 10px;
        padding: 0 8px;
    ...
    <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="loginmodal-container">
          <h1>G I R L T A L K</h1><br>
          <p>Welcome to our Semester 3 Exam. We have redesigned "Affald Indsamling's" website and hope you like it</p>
          <p>The password is <code> affaldindsamling</code></p>
          <form>
    ...
    this.shadowRoot.querySelector("form").addEventListener("submit", (e) => {
      e.preventDefault();
      if (this.shadowRoot.querySelector("input[name=pass]").value === "affaldindsamling") {
